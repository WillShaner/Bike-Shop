...
function Header() {
  const { cartItems, user, setUser, openModal, favoritesCount } =
  ...
  return (
    <Navbar sticky="top" expand="lg">
      <Container>
        ...
        >
          <h1 className="logo-text">The Bike Shop</h1>
        </NavLink>
        ...
        >
          <Nav>
            ...
            <NavLink
              onClick={() => closeMenuCloseSearch()}
              to="/favorite"
              className="header-link cart-logo logo-lg"
            >
              <AiOutlineHeart />
            ...
            <NavLink
              ...
              className="header-link cart-logo"
            >
              <HiSearch />
            </NavLink>
            ...
            {user === undefined ? (
              ...
              >
                ...
                <Button
                  variant="outlined"
                  className="user-logout-btn user-logout-btn-sm"
                  onClick={() => {
                    setUser(undefined);
                  }}
                >
      ...
      {searchOpen && (
        <SearchBar setSearchOpen={setSearchOpen} openModal={openModal} />
      )}
    </Navbar>
  );
}
